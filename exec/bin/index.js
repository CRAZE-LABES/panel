...
program
    .version("0.1.0-beta6")
    .description("Command Line Interface for the CrazePanel Panel");
...
program
    ...
    .action(async () => {
        ...
        try {
            const imagesIndexResponse = await axios.get('https://raw.githubusercontent.com/CRAZE-LABES/Images-crazepanel/main/seed/0.1.0-beta2.json');
